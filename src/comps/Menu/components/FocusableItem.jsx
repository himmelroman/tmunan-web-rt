...
import { mergeProps, commonProps, safeCall, menuClass, menuItemClass, roleMenuitem, stylePropTypes, withHovering, EventHandlersContext } from '../utils'

export const FocusableItem = withHovering('FocusableItem', function FocusableItem({ className, disabled, children, isHovering, itemRef, externalRef, ...restProps }) {
